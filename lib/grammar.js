...
const compareOperation = (property, operation, operator, value) => {
    if (operation === "is") {
        ...
        if (typeof property === 'object' && operator === "=" || operator === "!=") {
            return operator === "=" ? property[operation] === value : property[operation] !== value
        } else if (typeof property === 'number' && operator === "=" || operator === "!=") {
            return operator === "=" ? property === value : propert !== value
        }
    }
    return false
}
        ...
        if (tokenMap[t].value === null) {
            if (tokenMap[t].token) {
                if (tokenMap[t].token.substring(0, 2) === '[*') {
                    ...
                    console.log('id, context:', id, context, paths.length)
                    ...
                    if (paths.length === 3) {
                        ...
                        if (comp >= 0) {
                            ...
                            console.log(rl, operation, operator, value)
