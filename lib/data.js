        ...
        try {
            ...
            if (savemobiles) {
                ...
                for (let m in mobiles) {
                    ...
                    // TODO: Mobiles class needs a toJSON() method to properly avoid circular references during stringify.
                }
                //fs.writeFileSync(path.join(dir, config.mobilesfile), JSON.stringify(mobiles))
            }
            resolve()
        }
        catch (err) {
