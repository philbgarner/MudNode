 ...
 * @returns 
 */
 module.exports.getMobilesByLocation = function (uuid) {
    let mlist = []
...
module.exports.getMobilesByArea = function (uuid) {
    let mobs = []
    for (let m in moblist) {
...
module.exports.getMobileByUuid = function (uuid) {
    for (let m in moblist) {
...
module.exports.loadMobiles = function (buffer) {
