...
const Delayed = require('../../components/delayed')
...
class MixedForest extends RoomTemplate {
    constructor(params) {
        ...
        this.randomComponents = params.components ? params.components : [new Delayed({ delay: 10, OnEnd: (room) => room.SendMessage('Delayed!') })]
        ...
        this.components.push(new Delayed({ delay: 60, OnEnd: (room) => {
            room.SendMessage('Delayed!')
        }}))
    }
}
