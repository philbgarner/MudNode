import { Area, rooms, templating, MobileSpawner, areas, grammar } from '../../mudnode.js'
...
class AreaTemplate {
    constructor(params) {
        ...
        // Grammar syste, template description.
        this.area.props.descriptionTemplate = params.descriptionTemplate ? params.descriptionTemplate : 'No description template.'
        this.area.props.nameTemplate = params.nameTemplate ? params.nameTemplate : 'No name template.'
    }
    ...
    GenerateRooms (startTemplate, startLocation, depth) {
        ...
        return new Promise((resolve, reject) => {
            let roomTemplate = templating.create(startTemplate)
            let room = roomTemplate.NextRoom()
            if (room) {
